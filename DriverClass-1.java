//unit4.hw
//Group members: Enoch Kho, Justin Stefanski and Josh Herrera
...
class Student {
    ...
    public void printFeeInvoice() {
        ...
        System.out.println("                             ----------\n               Total Payments $ " + String.format("%.2f", (totalPayment - 0.25 * totalPayment)));
    }
    ...
    public void printCourseDetails() {
        ...
        for (int crn : listOfCrns) {
            System.out.printf("%-6d %-13s %-13d $%8.2f\n", crn, getCourseName(crn), getCreditHours(crn), getCourseCost(crn));
        }
    }
